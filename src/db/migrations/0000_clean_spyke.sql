...
CREATE TABLE "cart_items" (
	...
	CONSTRAINT "quantity_non_negative" CHECK ("cart_items"."quantity" >0)
);
--> statement-breakpoint
CREATE TABLE "carts" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE "products" (
	...
	CONSTRAINT "price_non_negative_check" CHECK ("products"."price" >=0),
	CONSTRAINT "stock_non_negative_check" CHECK ("products"."stock" >=0)
);
--> statement-breakpoint
CREATE TABLE "reviews" (
	...
	CONSTRAINT "rating_from_1_to_5" CHECK ("reviews"."rating" >= 1 AND "reviews"."rating" <= 5)
);
--> statement-breakpoint
CREATE TABLE "users" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
